...
# Mean values for preference scores
...
data['total_o'] = data['pref_o_attractive'] + data['pref_o_sincere'] + data['pref_o_intelligence'] \
                  + data['pref_o_funny'] + data['pref_o_ambitious'] + data['pref_o_shared_interests']
